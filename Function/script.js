    ...
    <div class="dash-panel" style="margin-bottom: var(--space-6); padding: 20px 24px; display: flex; align-items: center; gap: 20px; border-left: 4px solid ${dotColor};">
      <div style="flex: 1;">
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:8px;">
            <span style="width:12px; height:12px; border-radius:50%; background:${dotColor}; display:inline-block; box-shadow: 0 0 8px ${dotColor}80;"></span>
            <span style="font-size: 1rem; font-weight: 600; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.5px;">${countdown} until next exam</span>
        </div>
        <div style="font-size: 1.25rem; font-weight: 600; color: var(--text-primary); display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
  ...
  openModal('Settings', `
    <form id="settingsForm">
      ...
      <div class="form-group">
        ...
        <p style="font-size: 0.8rem; color: var(--text-tertiary); margin-top: 4px;">Subjects below this percentage are flagged as a risk.</p>
      </div>
      <div class="modal-actions" style="display:flex; justify-content: flex-end; width:100%;">
        <button type="submit" class="premium-btn primary-btn">Save settings</button>
      </div>
    </form>
    <div style="border-top:1px solid var(--rule-light); margin-top:24px; padding-top:24px;">
    ...
    const modalHtml = `
      ...
      <div id="profile-view-mode">
          ...
          <div class="dashboard-grid" style="grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 25px;">
              ...
              <div style="background: var(--surface-hover); padding: 15px; border-radius: 8px; text-align: center;">
                  <div style="font-size: 20px; font-weight: 600; color: #4F46E5;">${totalCredits}</div>
      ...
      <div id="profile-edit-mode" class="hidden">
          ...
          <div class="modal-actions" style="display:flex; gap:12px; justify-content: space-between; width:100%;">
            <button type="button" class="premium-btn outline-btn" id="cancel-edit-btn">Cancel</button>
            <button type="button" class="premium-btn primary-btn" id="save-profile-btn">Save Changes</button>
          </div>
      </div>
    `;
